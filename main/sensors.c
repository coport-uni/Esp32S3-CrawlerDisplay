...
static esp_err_t humiture_setup(void)
{
    ...
    sensor_event_handler_instance_t inst_t = NULL;
    sensor_event_handler_instance_t inst_h = NULL;
    iot_sensor_handler_register_with_type(HUMITURE_ID, SENSOR_TEMP_DATA_READY,
                                          humiture_event_cb, &inst_t);
    iot_sensor_handler_register_with_type(HUMITURE_ID, SENSOR_HUMI_DATA_READY,
                                          humiture_event_cb, &inst_h);
